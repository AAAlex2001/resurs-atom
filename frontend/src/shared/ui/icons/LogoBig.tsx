...
import style from "./LogoBig.module.scss";
...
export const LogoBig = () => {
    ...
    return (
        <svg className={style.svg} width="210" height="40" viewBox="0 0 210 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
            <g transform="translate(20 20)">
                <g className={style.orbits}>
            ...
            <text
                ...
                letterSpacing="0.2"
            >
                <tspan className={style.wordAtom}>Атом-</tspan>
                <tspan className={style.wordPlus}>Плюс</tspan>
            </text>
            <defs>
