...
@router.get("/tags", response_model=list[TagSchema], summary="Теги опубликованных статей")
async def get_tags(
    section: Section | None = Query(None, description="Только теги статей этого раздела"),
    service: ArticleService = Depends(),
) -> list[TagSchema]:
